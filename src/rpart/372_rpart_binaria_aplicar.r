...
PARAM$rpart$cp <- -0.229281730847031
PARAM$rpart$minsplit <- 1360.22827742832
PARAM$rpart$minbucket <- 678.0019485
...
setwd("/home/nestor_dileo2009") # Establezco el Working Directory
