...
hs <- makeParamSet(
  ...
  makeIntegerParam("minsplit", lower = 1L, upper = 20000L),
...
ksemilla_azar <- 330359 # cambiar por la primer semilla
...
dir.create("./exp/HT3212/", showWarnings = FALSE)

# Establezco el Working Directory DEL EXPERIMENTO
setwd("./exp/HT3212/")


archivo_log <- "HT3212.txt"
archivo_BO <- "HT3212.RDATA"
